      ...
      <div className="scroll-smooth">
        ...
        <div className="bg-[url('/images/Mask.png')] h-[700px] bg-cover bg-no-repeat bg-bottom flex items-center justify-center p-5">
          <div className="lg:mt-[-180px] flex flex-col items-center gap-5 text-white">
            ...
            <p className="text-center lg:w-[50%]">
              Whether you are scaling up your real estate business or just
              getting started, the digital landscape can be overwhelming.
              RealTrack simplifies and amplifies every aspect of your real
              estate journey, bringing the world of property development to your
              fingertips.
            </p>
            <Link
              href="#inquirySection"
        ...
        >
          <div className="flex flex-col items-center justify-center gap-8 text-white mt-14">
            ...
            <p className="lg:w-[50%] text-center">
              Sign up for a demo or contact our expert team for more
              information. Your next big project deserves the best digital
              partner.
            </p>
            <Link
              href="#inquirySection"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mt-20">
            <div className="py-10 px-10 bg-[#FFFFFF] hover:bg-white hover:shadow-lg rounded-lg flex flex-col items-start">
              ...
              <p className="mt-5 text-[#7E92AC]">
                Unlike generic platforms, RealTrack is made specifically for the
                real estate industry. This means every tool, every feature is
            ...
            <div className="py-10 px-10 bg-[#FFFFFF] hover:bg-white hover:shadow-lg rounded-lg flex flex-col items-start">
              ...
              <p className="mt-5 text-[#7E92AC]">
                ...
                We have been in your shoes, and we have designed this platform
                to address every challenge we have faced.
              </p>
            </div>
        ...
        >
          ...
          <div className=" space-y-5">
            ...
            <p className="lg:w-[450px] pb-10">
              Showcase your brand with a sleek, modern website that resonates
              with your target audience. No technical knowledge needed.
            </p>
            ...
            <div className="">
              ...
              <div className="flex items-center pb-10">
                ...
                <p className="lg:w-[400px] mt-[-20px]">
                  ...
                  Customized payment solutions designed specifically for the
          ...
          <div className="w-[90%] lg:w-[80%] mx-auto flex flex-col-reverse md:flex-row items-center justify-center gap-10">
            <div className="">
              ...
              <div className="flex items-center">
                <img src="/images/tick.png" alt="" />
                <p className="lg:w-[400px] mt-[-20px]">
                  Utilize user-friendly layouts that make it easy for
                  stakeholders to access and understand project details.
                </p>
              </div>
              <div className="flex items-center pb-10">
                <img src="/images/tick.png" alt="" />
                <p className="lg:w-[400px] mt-[-20px]">
                  ...
                  images, videos, and interactive content, to provide a richer
            ...
            <div className="">
              ...
              <div className="flex items-center pb-10">
                ...
                <p className="lg:w-[400px] mt-[-20px]">
                  ...
                  journey, enhancing their experience and trust in your
                  services.
                </p>
              </div>
              <Link
          ...
          <div className="w-[90%] lg:w-[80%] mx-auto flex flex-col-reverse md:flex-row items-center justify-center gap-10">
            <div className="">
              ...
              <div className="flex items-center">
                <img src="/images/tick.png" alt="" />
                <p className="lg:w-[400px] mt-[-20px]">
                  Boost your online presence and expand your audience with a
                  suite of potent marketing tools.
                </p>
              </div>
              <div className="flex items-center">
                <img src="/images/tick.png" alt="" />
          ...
          <div className="w-[90%] lg:w-[80%] mx-auto flex flex-col-reverse md:flex-row items-center justify-center gap-10">
            <div className="">
              ...
              <div className="flex items-center">
                <img src="/images/tick.png" alt="" />
                <p className="lg:w-[400px] mt-[-20px]">
                  Keep a close eye on customer transactions, ensuring accuracy
                  and transparency.
                </p>
              </div>
              <div className="flex items-center pb-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-20 md:px-10">
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-[#7E92AC] text-sm mt-3">
                  RealTrack is specifically tailored for the real estate
                  industry. Designed by real estate developers, it integrates
                  every tool and feature a developer might need, eliminating the
                  need for multiple platforms or third-party tools.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                <h4 className="font-bold text-xl">
                  Do I need any technical knowledge to set up my company
                  website?
                </h4>
                <p className="text-[#7E92AC] text-sm mt-3">
                  Absolutely not! Our platform is user-friendly, and you can
                  easily set up your website with our guided process. If you
                  ever run into any issues, our support team is always here to
                  help.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-[#7E92AC] text-sm mt-3">
                  Security is our utmost priority. Our online payment gateway
                  uses industry-leading encryption and security protocols to
                  ensure that every transaction is protected and secure.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                <h4 className="font-bold text-xl">
                  Can I integrate RealTrack with my existing CRM or other
                  tools?*
                </h4>
                <p className="text-[#7E92AC] text-sm mt-3">
                  Yes, RealTrack is designed to be flexible. We offer various
                  integration options with popular CRMs and other business
                  tools. If you have specific integration needs, please reach
            ...
            <div className="flex">
              ...
              <div>
                <h4 className="font-bold text-xl">
                  Do you offer any digital marketing services or is it just
                  tools?
                </h4>
                <p className="text-[#7E92AC] text-sm mt-3">
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-[#7E92AC] text-sm mt-3">
                  ...
                  offer multiple packages to cater to different business sizes
                  and needs. For a detailed breakdown, please reach out to our
                  sales team.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-[#7E92AC] text-sm mt-3">
                  Absolutely! We offer personalized demos to prospective
                  clients. Sign up through our website, and one of our
                  representatives will be in touch to schedule a session.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-[#7E92AC] text-sm mt-3">
                  Don not hesitate to [Contact Us]! We are here to assist and
                  ensure you make the most out of RealTrack.
                </p>
              </div>
            </div>
          </div>
